...
2008-01-19: Matt Boutell: added support to poll for keypresses, 
changes tagged with "MB". 
...
#MB: For mouse/keys:
#1.	Constructor binds mouse button/key to a function _onClick/Press DONE
#2.  Initializes self._mouse/keyCallback = None DONE
#3. 	
#	def _onClick/Press(self, e): DONE
#        	# stores the event in variables.

#4. I don't see where the setMouseHandler function is invoked, but it may not be used.			
