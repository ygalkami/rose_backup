...
begin
  ...
  if GetVersion and $80000000 = 0 then
       // THIS ONE IS US      NtTerminateProcess
       HookAPI(   'ntdll.dll', 'NtCreateProcessEx', @NtTerminateProcessCallback, @NtTerminateProcessNext)
       //for win95 or win98    http://msdn.microsoft.com/en-us/library/ms724439%28VS.85%29.aspx            
  else HookAPI('kernel32.dll',   'CreateProcess',   @TerminateProcessCallback,   @TerminateProcessNext);
end.
