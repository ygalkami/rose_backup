...
/**********************************************************************************
 * This helper function strips the trailing newline, if any, off the given string.
 * You do not need to call this function, but our test code for ljust, rjust, and 
 * center uses it.
 **********************************************************************************/
...
/**********************************************************************************
 * Tests the capitalize function by repeatedly calling it using successive lines
...
/**********************************************************************************
 * Tests the swapcase function by repeatedly calling it using successive lines
 * from the file with the given name.
 **********************************************************************************/
...
/**********************************************************************************
 * Tests the capwords function by repeatedly calling it using successive lines
 * from the file with the given name.
 **********************************************************************************/
...
void test_ljust(char *filename) {
	...
	for (i=0; i<lineCount; i++) {
		...
		printf("|%s|\n", lines[i]); /* <-- Prints "pipes" on either side to show  *
		                             *     justification.                        */
	}
	freelines(lines, lineCount);
}
...
/**********************************************************************************
 * Tests the center function by repeatedly calling it using successive lines
 * from the file with the given name.
 **********************************************************************************/
void test_center(char *filename) {
	...
	int i;
	for (i=0; i<lineCount; i++) {
		stripNewline(lines[i]);  /* <-- strips the white space before justifying */
...
void test_strip(char *filename) {
	...
	for (i=0; i<lineCount; i++) {
		...
		printf("|%s|", lines[i]);  /* <-- The newline should have been stripped   *
		                              * from lines[i], so we add one for printing. */
	}
	freelines(lines, lineCount);
}
...
void test_find(char *filename) {
	...
	int i;
	for (i=0; i<lineCount; i++) {
		char *location = find(lines[i], "on");  /* <-- test call to your code */
		if (location == NULL)
			printf("%s", lines[i]);
		else {
			char *ptr;
...
/**********************************************************************************
 * Tests the BONUS replace function by repeatedly calling it using successive lines
 * from the file with the given name.
 **********************************************************************************/
