// This is the file you should modifiy for problem 2A
...
class BinaryNode {
	...
	/*
	 * TODO: (Problem 2A)  Add the equals() method
	 */
	...
	public boolean equals(BinaryNode t) {
...
//		System.out.println(this.InOrder());
		...
		if (t.InOrder().equals(this.InOrder()))
			return true;
		return false;
	}
